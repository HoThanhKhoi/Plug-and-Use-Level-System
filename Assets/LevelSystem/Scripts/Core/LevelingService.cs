...
public class LevelingService : MonoBehaviour, ILevelingFacade
{
	...
	private Dictionary<LevelingCategory, IExperienceTracker> experienceGainers
	...
	private void Awake()
	{
		...
		if (!levelingRegistry)
		{
			levelingRegistry = FindAnyObjectByType<LevelingRegistrySO>();
		}
	}
	...
	public void RegisterLevelingSystem(LevelingCategory category, IExperienceTracker xpGainer, ILevelTracker progression)
	{
